...
3. **Monthly deep clean** — 120 minutes, first Saturday. Full textile cycle including curtains, concealed reservoirs, appliance interfaces, air and moisture systems.

Shared logic — definitions, order of operations, zoning, cloth assignment, contact time, incompatible combinations, balcony containment, agent selection and completion criteria — is stated once in the standing-principles section and applies to all three phases.
